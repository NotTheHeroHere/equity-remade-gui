        ...
        while i <= 1:
            ...
            try:
                ...
                if bal > 2000000000000000:
                    ...
                    if badhitlogging == True: print("\033[31m[BAD HIT] |\033[33m " + str(account.address) + "\033[31m |\033[33m cracked but insufficient balance of \033[32m" + str(bal/1000000000) + " ETH \033[31m| Counter: " + str(bdhits.value) +"\033[0m")
                    consERR = 0
                    time.sleep(0.02)
            except Exception as e:
...
if __name__=="__main__":
    try:
        ...
        dbug.close()
        minerAddress = input("\033[37mWelcome! Enter your ETHEREUM address to start mining: ")
        if len(minerAddress) == 42:
            print("Mining address accepted!")
            intensity = input("Please input desired CPU intensity for mining (1-100): ")
            if int(intensity) >= 1 and int(intensity) <= 100:
                print("Selected %s as CPU intensity\033[0m"%str(intensity))
                webhookboolean = input("Do you want to enable Discord Webhook logging (Y-N): ")
                if webhookboolean.lower() == "yes" or webhookboolean.lower() == "y":
                    ...
                    os.system("pause")
                    exit()
                badhitboolean = input("Do you want to enable bad hit logging (Y-N): ")
                ...
                time.sleep(1)
                if w3.isConnected():
                    print("\033[32mMiner starting... [Buidling child processes...]")
                    if __name__=="__main__":
                        multiprocessing.freeze_support()
                        ...
                        print('\033[32m╚══════╝░░░╚═╝░░░░╚═════╝░╚═╝░░░╚═╝░░░░░░╚═╝░░░  ░░░╚═╝░░░╚═╝░░░░░░░░╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚══════╝╚═╝░░╚═╝')
                        print("V 1.3")
                        print("Starting mining processes..\033[0m \n")
                        if (webhookurl != "null"):
                            webhook = DiscordWebhook(url=webhookurl, rate_limit_retry=True)
                    ...
                    if w3.isConnected():
                        ...
                        if __name__=="__main__":
                            ...
                            print('\033[32m╚══════╝░░░╚═╝░░░░╚═════╝░╚═╝░░░╚═╝░░░░░░╚═╝░░░  ░░░╚═╝░░░╚═╝░░░░░░░░╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚══════╝╚═╝░░╚═╝')
                            print("")
                            print("\033[32mStarting mining processes..\033[0m \n")
                            if (webhookurl != "null"):
                                webhook = DiscordWebhook(url=webhookurl, rate_limit_retry=True)
                                embed = DiscordEmbed(title="EQUITY WMINER | MINING...", description="Miner started!", color=0x00ff00)
                                embed.add_embed_field(name="Miner Address", value=minerAddress, inline=False)
